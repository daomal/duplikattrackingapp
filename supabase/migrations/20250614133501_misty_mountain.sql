...
-- Fixed version that handles dependencies correctly
...
DROP POLICY IF EXISTS "profiles_anonymous_select" ON profiles;
...
-- Create the trigger AFTER creating the function
